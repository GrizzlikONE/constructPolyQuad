...
{
	return {
		"name":			"PolyQuad",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"PolyQuad",				// this is used to identify this plugin and is saved to the project; never change it
...
//sap:
AddAction(20, af_none, "Add Collider", "Polygon", "Add collider to polygon", "Add collider to the polygon described by its vertex list", "colliderPolygon");
