...
//          vvvvvvvv
cr.plugins_.PolyQuad = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.PolyQuad.prototype;
	...
	Acts.prototype.drawPolygon = function (fillColor,lineWidth,lineColor)
	{
		...
		this.runtime.trigger(cr.plugins_.PolyQuad.prototype.cnds.OnDrawn, this);
	};


	//sap:
	Acts.prototype.colliderPolygon = function ()
	{
		var right,bottom,left,top;
		var width,height;
		var vertices = this.vertices;
